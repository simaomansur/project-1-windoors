...
class User(db.Model, UserMixin):
    ...
    #override get_id method to return email instead of id
    def get_id(self):
...
class Product(db.Model):
    ...
    items = db.relationship('Item', back_populates='product', cascade="all, delete-orphan")
...
class Order(db.Model):
    ...
    items = db.relationship('Item', back_populates='order', lazy=True)
...
class Item(db.Model):
    ...
    #This looks nice, pleasing to mine eyes.